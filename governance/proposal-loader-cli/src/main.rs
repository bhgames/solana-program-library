...
const GOVERNANCE_PROGRAM_ID: &str = "C3FdFYAwoAanUUHrtxnnzN8A6R13RmRoDRWmLbcpZATp";
...
const GOVERNED_PROGRAM_ID: &str = "71EdfAuGX2bDyNyVhatDREZph3dUaa9TBZv3L24qNFRG";
